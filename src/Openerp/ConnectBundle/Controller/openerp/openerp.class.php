...
include("xmlrpc-2.2.2/lib/xmlrpc_wrappers.inc");

class OpenERP {

    public $server = "http://181.111.252.91:8369/xmlrpc/";
    public $database = "";
    ...
    public function login($username = "admin", $password = "a", $database = "test", $server = "http://181.111.252.91:8369/xmlrpc/") {
        $this->server = $server;
